    ...
    render() {
        return (
            <div className=' pt-2 pb-2 container' >
                <div class="pb-2 pt-1 container border border-dark" >
                    <h6>Call Details</h6>
                    <div className='row' >
                    ...
                    <div className='row' >
                        <div className='col-4 pt-1'><h4>Events</h4></div>
                    ...
                    <div className='row' >
                        <div style={{height: '100px', width: '95%' }} className='mt-2 ml-2  border border-dark' ></div>

                    </div>
                </div>
                <div style={{height: '100px', }} className='mt-2 pl-2 border border-dark' >
                    <div className='pb-5'>Participants </div>
                </div>
            </div >
        )
    }
